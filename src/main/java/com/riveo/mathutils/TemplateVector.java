...
import com.riveo.functional.ICombineFunction;
import com.riveo.functional.IConditionFunction;
import com.riveo.functional.IFillFunction;
import com.riveo.functional.IForEachApplyFunction;
import com.riveo.functional.IForEnumerateApplyFunction;
import com.riveo.functional.IMapFunction;
import com.riveo.functional.IReduceFunction;
...
public class TemplateVector<T> implements Iterable<T>, Cloneable {
    ...
    public T get(final int index) {
        if (notInRange(index))
            throw new RuntimeException(String.format("get :: index {%s} out of range", index));
